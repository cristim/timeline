...
func scanWikidataDumpLimited(r io.Reader, maxRecordBytes int64, counters *dumpCounters, visit func(wikidataDumpItemFacts) error) (wikidataDumpScanStats, error) {
